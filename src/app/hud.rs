...
impl Hotbar {
    pub fn new(gfx: &mut Graphics) -> Self {
        ...
        let hotbar_texture = Texture::new(
            gfx,
    ...
    pub fn set_selected_slot(&mut self, selected_slot: u32) {
    ...
    pub fn draw(&self, gfx: &mut Graphics) {
        gfx.ui_renderer_mut().queue_drawable(self.base.clone());
        gfx.ui_renderer_mut().queue_drawable(self.selector.clone());
    }
}
